...
const validRequests = {
	...
	'add-notification': Joi.alternatives().try(Joi.object({ userid: isCassandraUUID, token: isToken, domainName: isDomain, checkId: isCassandraUUID, notifyType: isNotifyHTTP, notifyTarget: isURL, notifyUp: isNotifyDelay, notifyDown: isNotifyDelay }),
					    Joi.object({ userid: isCassandraUUID, token: isToken, domainName: isDomain, checkId: isCassandraUUID, notifyType: isNotifyMail, notifyTarget: isEmail, notifyUp: isNotifyDelay, notifyDown: isNotifyDelay }),
					    Joi.object({ userid: isCassandraUUID, token: isToken, domainName: isDomain, checkId: isCassandraUUID, notifyType: isNotifySMS, notifyTarget: isPhoneNumber, notifyUp: isNotifyDelay, notifyDown: isNotifyDelay }),
					    ...
					    Joi.object({ domainName: isDomain, dowhat: isActionHelper, checkId: isCassandraUUID, notifyType: isNotifyMail, notifyTarget: isEmail, notifyUp: isNotifyDelay, notifyDown: isNotifyDelay }),
					    Joi.object({ domainName: isDomain, dowhat: isActionHelper, checkId: isCassandraUUID, notifyType: isNotifySMS, notifyTarget: isPhoneNumber, notifyUp: isNotifyDelay, notifyDown: isNotifyDelay })),
	'add-record': Joi.alternatives().try(Joi.object({ userid: isCassandraUUID, token: isToken, domainName: isDomain, recordName: isName, recordPriority: isPriority, setId: isSetID, recordTarget: isIPv4, recordType: typeNeedsIPv4, recordTtl: isTtl, recordCheckId: isCheckId }),
					    Joi.object({ userid: isCassandraUUID, token: isToken, domainName: isDomain, recordName: isName, recordPriority: isPriority, setId: isSetID, recordTarget: isIPv6, recordType: typeNeedsIPv6, recordTtl: isTtl, recordCheckId: isCheckId }),
					    Joi.object({ userid: isCassandraUUID, token: isToken, domainName: isDomain, recordName: isName, recordPriority: isPriority, setId: isSetID, recordTarget: isName, recordType: typeNeedsName, recordTtl: isTtl, recordCheckId: isCheckId }),
					    Joi.object({ userid: isCassandraUUID, token: isToken, domainName: isDomain, recordName: isName, recordPriority: isPriority, setId: isSetID, recordTarget: isString, recordType: typeNeedsString, recordTtl: isTtl, recordCheckId: isCheckId }),
					    Joi.object({ domainName: isDomain, dowhat: isActionHelper, recordName: isName, recordPriority: isPriority, setId: isSetID, recordTarget: isIPv4, recordType: typeNeedsIPv4, recordTtl: isTtl, recordCheckId: isCheckId }),
					    Joi.object({ domainName: isDomain, dowhat: isActionHelper, recordName: isName, recordPriority: isPriority, setId: isSetID, recordTarget: isIPv6, recordType: typeNeedsIPv6, recordTtl: isTtl, recordCheckId: isCheckId }),
					    Joi.object({ domainName: isDomain, dowhat: isActionHelper, recordName: isName, recordPriority: isPriority, setId: isSetID, recordTarget: isName, recordType: typeNeedsName, recordTtl: isTtl, recordCheckId: isCheckId }),
					    Joi.object({ domainName: isDomain, dowhat: isActionHelper, recordName: isName, recordPriority: isPriority, setId: isSetID, recordTarget: isString, recordType: typeNeedsString, recordTtl: isTtl, recordCheckId: isCheckId }),
					    Joi.object({ domainName: isDomain, dowhat: isActionHelper, recordName: isName, recordPriority: isPriority, setId: isSetID, recordTarget: isIPv4, recordType: typeNeedsIPv4, recordTtl: isTtl }),
					    Joi.object({ domainName: isDomain, dowhat: isActionHelper, recordName: isName, recordPriority: isPriority, setId: isSetID, recordTarget: isIPv6, recordType: typeNeedsIPv6, recordTtl: isTtl }),
					    Joi.object({ domainName: isDomain, dowhat: isActionHelper, recordName: isName, recordPriority: isPriority, setId: isSetID, recordTarget: isName, recordType: typeNeedsName, recordTtl: isTtl }),
					    Joi.object({ domainName: isDomain, dowhat: isActionHelper, recordName: isName, recordPriority: isPriority, setId: isSetID, recordTarget: isString, recordType: typeNeedsString, recordTtl: isTtl })),
	...
	'del-notification': Joi.alternatives().try(Joi.object({ userid: isCassandraUUID, token: isToken, domainName: isDomain, checkId: isCassandraUUID }),
					    Joi.object({ domainName: isDomain, checkId: isCassandraUUID })),
	'del-record': Joi.alternatives().try(Joi.object({ userid: isCassandraUUID, token: isToken, domainName: isDomain, recordName: isName, setId: isSetID, recordType: isType }),
					    Joi.object({ domainName: isDomain, recordName: isName, setId: isSetID, recordType: isType })),
	...
	'get-record-get': { domainName: isDomain, recordName: isName },
	'get-record-post': { userid: isCassandraUUID, token: isToken, domainName: isDomain, recordName: isName },
	...
	'settings-get': { },
	'settings-post': Joi.alternatives().try(Joi.object({ userid: isCassandraUUID, token: isToken, email: isEmail, password: isPassword }),
					    Joi.object({ userid: isCassandraUUID, token: isToken, email: isEmail }),
					    Joi.object({ email: isEmail, password: isPassword }),
					    Joi.object({ email: isEmail }))
    };
