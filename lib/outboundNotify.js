...
module.exports = (cassandra, notify) => {
	return new Promise((resolve, reject) => {
		...
		cassandra.execute(lookupHistory, [], { consistency: drv.types.consistencies.localQuorum })
		    .then((resp) => {
				...
				if (count === limit) {
				    ...
				    cassandra.execute(lookupTarget, [], { consistency: drv.types.consistencies.localQuorum })
					.then((tgt) => {
