...
module.exports = (app, cassandra, confQueues, zonesQueues) => {
	...
	app.get('/', (req, res) => {
		getProbe.mark();
		if (req.session.username !== undefined) { res.send('highwaytohell API gateway ' + tag); }
	...
	app.get('/logout', (req, res) => {
		...
		try {
		    ...
		    delete req.session;
		    res.redirect(301, '/login');
		} catch(e) { res.redirect(301, '/login'); }
	    });
	...
	app.post('/notifications/:domainName/add/:checkId', (req, res) => {
		...
		cmdValidation(req, res, 'add-notification')
		    ...
		    .catch((e) => {
			    ...
			    logger.error(e);
			    res.status(400).send('invalid input adding notification');
			});
	    });
	...
	app.post('/notifications/:domainName/del/:checkId', (req, res) => {
		...
		cmdValidation(req, res, 'del-notification')
		    ...
		    .catch((e) => {
			    ...
			    logger.error(e);
			    res.status(400).send('invalid input dropping notification');
			});
	    });
	...
	app.post('/notifications/:domainName/edit/:checkId', (req, res) => {
		...
		cmdValidation(req, res, 'add-notification')
		    ...
		    .catch((e) => {
			    ...
			    logger.error(e);
			    res.status(400).send('invalid input editing notification');
			});
	    });
	...
	app.get('/notifications/:domainName', (req, res) => {
		...
		cmdValidation(req, res, 'get-notifications-get')
		    ...
		    .catch((e) => {
			    ...
			    logger.error(e);
			    if (req.session.username !== undefined) {
				renderWith['errormsg'] = 'faulty input listing notifications';
				let output = Mustache.render(templates['backendError'], renderWith);
				res.send(output);
			    } else {
