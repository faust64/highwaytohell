	...
	app.get('/settings', (req, res) => {
		...
		cmdValidation(req, res, 'settings-get')
		    .then((params) => {
			    authValidation(cassandra, req, 'settings:ro')
				.then((userId) => {
				    let disable2fa = "<table align='center'><tr><td><img src='/static/healthy.png' height='20px' width='20px' alt=''/>"
						    ...
						    + "</form></td></tr></table>";
				    let enable2fa = "<table align='center'><tr><td><img src='/static/unhealthy.png' height='20px' width='20px' alt=''/>"
