...
module.exports = (cassandra, userId, target) => {
	return new Promise ((resolve, reject) => {
		...
		cassandra.execute(checkPrimary, [], { consistency: drv.types.consistencies.localQuorum })
		    .then((primary) => {
				...
				cassandra.execute(dropContact, [], { consistency: drv.types.consistencies.localQuorum })
