...
module.exports = (cassandra, userId) => {
	return new Promise ((resolve, reject) => {
		...
		cassandra.execute(getSettings, [], { consistency: drv.types.consistencies.localQuorum })
		    .then((stgs) => {
			    ...
			    cassandra.execute(getUser, [], { consistency: drv.types.consistencies.localQuorum })
				.then((resp) => {
